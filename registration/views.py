...
def activate(request, backend,
    ...
    ``activate.html`` to display an error message; to
    ...
    **Arguments**
    ...
    ``template_name``
        ...
        this will default to ``activate.html``.
    ...
    **Template:**
    ...
    activate.html or ``template_name`` keyword argument.
